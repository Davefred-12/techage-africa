// ============================================
// FILE: src/pages/Login.jsx - FIXED
// ============================================
...
import WelcomeModal from '../components/modals/WelcomeModal'; // ✅ Import
import ContinueLearningModal from '../components/modals/ContinueLearningModal'; // ✅ Import
...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // ✅ Check if first login (new user)
      if (response.isFirstLogin) {
        toast.success(`Welcome to TechAge Africa, ${response.user.name}! 🎉`);
        setShowWelcomeModal(true);
      } 
      // ✅ Check if returning user with in-progress course
      else if (response.lastAccessedCourse) {
        toast.success(`Welcome back, ${response.user.name}! 👋`);
        setLastCourse(response.lastAccessedCourse);
        setShowContinueModal(true);
      } 
      // ✅ Regular returning user with no in-progress courses
      else {
        toast.success(`Welcome back, ${response.user.name}! 👋`);
        setTimeout(() => {
  ...
  // ✅ Handle modal closes - navigate after close

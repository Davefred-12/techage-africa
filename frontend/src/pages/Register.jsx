...
const Register = () => {
  ...
  const benefits = [
    ...
    { icon: CheckCircle, text: "Access courses on any device" },
    { icon: CheckCircle, text: "Join active learning community" },
        ...
        <div className="relative z-10 max-w-lg space-y-8 text-white">
          <div className="space-y-4 animate-slide-up animation-delay-200">
            ...
            <p className="text-lg text-white/90">
              Join thousands of Africans learning in-demand digital skills and
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 transition-all ${
                        errors.fullName ? "border-danger-500 shake" : ""
                      }`}
                    />
                  </div>
                  {errors.fullName && (
                ...
                <div className="animate-slide-up animation-delay-600">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 pr-10 transition-all ${
                        errors.confirmPassword ? "border-danger-500 shake" : ""
                      }`}
                    />
                    <button
                      type="button"

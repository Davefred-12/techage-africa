// ============================================
// FILE: src/pages/Courses.jsx - Enhanced with Compact Header
// ============================================
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="p-5 space-y-3">
                      ...
                      <Badge
                        variant="secondary"
                        className="text-xs bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 hover:bg-primary-200 dark:hover:bg-primary-900/50 transition-colors"
                      >
                        {course.category}
                      </Badge>
                    ...
                    <CardFooter className="p-5 pt-0 flex justify-between items-center border-t">
                      ...
                      <Button
                        size="sm"
                        className="transition-all duration-300 group-hover:shadow-lg group-hover:scale-105"
                      >
                        View Details
                      </Button>
                    </CardFooter>
